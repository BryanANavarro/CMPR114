...
def displayYearlyCost(loan, insurance, gas, oil, tires, maintenance):
	...
	print("\nYearly Costs: ")
	print(f"Total Loan amount: ${yearlyLoan:.2f}")
	print(f"Total Insurance amount: ${yearlyIns:.2f}")
	print(f"Total Gas amount: ${yearlyGas:.2f}")
	print(f"Total Oil amount: ${yearlyOil:.2f}")
	print(f"Total Tires amount: ${yearlyTires:.2f}")
	print(f"Total Maintenance amount: ${yearlyMaintenance:.2f}")
